# 150MHz v8 — final_conv S_IC_PREPROC + feat_buf wr reg + Explore directives
...
set xdc_fh [open "${report_dir}/clk_150MHz_v8.xdc" w]
puts $xdc_fh "create_clock -period 6.667 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_150MHz_v8.xdc"

set TIME_start [clock seconds]

puts "============================================================"
puts "  150MHz v8 — final_conv pipe + feat_buf wr reg + Explore"
puts "============================================================"
...
puts "  150MHz_v8 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -file "${report_dir}/150MHz_v8_timing.rpt"
report_utilization -file "${report_dir}/150MHz_v8_utilization.rpt"
write_checkpoint -force "${report_dir}/150MHz_v8_impl.dcp"
