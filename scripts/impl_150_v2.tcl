# 150MHz v2 — preprocessing pipeline registers (feat_preproc_r / wt_preproc_r)
...
set xdc_fh [open "${report_dir}/clk_150MHz_v2.xdc" w]
puts $xdc_fh "create_clock -period 6.667 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_150MHz_v2.xdc"

set TIME_start [clock seconds]

puts "============================================================"
puts "  150MHz v2 — preprocessing pipeline registers"
puts "============================================================"
...
puts "  150MHz_v2 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -name "timing_1" -file "${report_dir}/150MHz_v2_timing.rpt"
report_utilization -file "${report_dir}/150MHz_v2_utilization.rpt"
write_checkpoint -force "${report_dir}/150MHz_v2_impl.dcp"
