# 150MHz v6 — DONT_TOUCH all engines + feature_buffer write-side register
...
set xdc_fh [open "${report_dir}/clk_150MHz_v6.xdc" w]
puts $xdc_fh "create_clock -period 6.667 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_150MHz_v6.xdc"

set TIME_start [clock seconds]

puts "============================================================"
puts "  150MHz v6 — DONT_TOUCH all engines + feat_buf wr reg"
puts "============================================================"
...
puts "  150MHz_v6 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -file "${report_dir}/150MHz_v6_timing.rpt"
report_utilization -file "${report_dir}/150MHz_v6_utilization.rpt"
write_checkpoint -force "${report_dir}/150MHz_v6_impl.dcp"
