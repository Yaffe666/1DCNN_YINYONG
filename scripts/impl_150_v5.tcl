# 150MHz v5 — current RTL baseline (pointwise pipeline only, all others reverted)
...
set xdc_fh [open "${report_dir}/clk_150MHz_v5.xdc" w]
puts $xdc_fh "create_clock -period 6.667 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_150MHz_v5.xdc"

set TIME_start [clock seconds]

puts "============================================================"
puts "  150MHz v5 — current RTL baseline (pointwise pipe only)"
puts "============================================================"
...
puts "  150MHz_v5 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -file "${report_dir}/150MHz_v5_timing.rpt"
report_utilization -file "${report_dir}/150MHz_v5_utilization.rpt"
write_checkpoint -force "${report_dir}/150MHz_v5_impl.dcp"
