# 100MHz implementation — gap_unit pipelined reciprocal
...
set xdc_fh [open "${report_dir}/clk_100MHz_v3.xdc" w]
puts $xdc_fh "create_clock -period 10.000 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_100MHz_v3.xdc"
...
puts "100MHz_v3 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -name "timing_1" -file "${report_dir}/100MHz_v3_timing.rpt"
report_utilization -file "${report_dir}/100MHz_v3_utilization.rpt"
