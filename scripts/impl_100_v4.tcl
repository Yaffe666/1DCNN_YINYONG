# 100MHz implementation — approach B: DONT_TOUCH on pipeline registers
...
set xdc_fh [open "${report_dir}/clk_100MHz_v4.xdc" w]
puts $xdc_fh "create_clock -period 10.000 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_100MHz_v4.xdc"

set TIME_start [clock seconds]

puts "============================================================"
puts "  synth_design (approach B: DONT_TOUCH pipeline registers)"
puts "============================================================"
...
puts "  100MHz_v4 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -name "timing_1" -file "${report_dir}/100MHz_v4_timing.rpt"
report_utilization -file "${report_dir}/100MHz_v4_utilization.rpt"
write_checkpoint -force "${report_dir}/100MHz_v4_impl.dcp"
