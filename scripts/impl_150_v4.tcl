# 150MHz v4 — feature_buffer write input registers to fix long routing
...
set xdc_fh [open "${report_dir}/clk_150MHz_v4.xdc" w]
puts $xdc_fh "create_clock -period 6.667 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_150MHz_v4.xdc"

set TIME_start [clock seconds]

puts "============================================================"
puts "  150MHz v4 — all engines pipelined + feature_buffer write reg"
puts "============================================================"
...
puts "  150MHz_v4 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -file "${report_dir}/150MHz_v4_timing.rpt"
report_utilization -file "${report_dir}/150MHz_v4_utilization.rpt"
write_checkpoint -force "${report_dir}/150MHz_v4_impl.dcp"
