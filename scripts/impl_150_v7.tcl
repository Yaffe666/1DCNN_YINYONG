# 150MHz v7 — final_conv pipeline (S_IC_PREPROC) + feature_buffer write reg
...
set xdc_fh [open "${report_dir}/clk_150MHz_v7.xdc" w]
puts $xdc_fh "create_clock -period 6.667 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_150MHz_v7.xdc"

set TIME_start [clock seconds]

puts "============================================================"
puts "  150MHz v7 — final_conv S_IC_PREPROC pipeline"
puts "============================================================"
...
puts "  150MHz_v7 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -file "${report_dir}/150MHz_v7_timing.rpt"
report_utilization -file "${report_dir}/150MHz_v7_utilization.rpt"
write_checkpoint -force "${report_dir}/150MHz_v7_impl.dcp"
