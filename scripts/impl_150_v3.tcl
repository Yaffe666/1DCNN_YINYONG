# 150MHz v3 — all engines pipelined (input regs + preproc + DONT_TOUCH)
...
set xdc_fh [open "${report_dir}/clk_150MHz_v3.xdc" w]
puts $xdc_fh "create_clock -period 6.667 \[get_ports clk\]"
close $xdc_fh
read_xdc "${report_dir}/clk_150MHz_v3.xdc"

set TIME_start [clock seconds]

puts "============================================================"
puts "  150MHz v3 — all engines pipelined"
puts "============================================================"
...
puts "  150MHz_v3 done in [expr {$elapsed/60}]m[expr {$elapsed%60}]s"

report_timing_summary -file "${report_dir}/150MHz_v3_timing.rpt"
report_utilization -file "${report_dir}/150MHz_v3_utilization.rpt"
write_checkpoint -force "${report_dir}/150MHz_v3_impl.dcp"
